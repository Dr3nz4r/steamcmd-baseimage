...
#                        ca-certificates curl g++ gcc gcc-8-base gdb gdebi-core gnupg init lib32gcc1 lib32stdc++6 lib32z1 libbz2-1.0:i386 libc-bin libcurl3-gnutls:i386 libdebconfclient0 libjpeg62:i386 libncurses5:i386 libncursesw5:i386 libstdc++6:i386 libtinfo5:i386 libxcursor1:i386 libxext6:i386 libxft2:i386 libxinerama1:i386 locales ncurses-base ncurses-bin net-tools software-properties-common tmux wget \
#debian
                       libtcmalloc-minimal4 tmux locales net-tools wget ca-certificates tar gcc g++ lib32gcc1 libgcc1 libcurl4-gnutls-dev:i386 libssl1.1 libcurl4:i386 libtinfo5 lib32z1 lib32stdc++6 libncurses5:i386 libcurl3-gnutls:i386 gdb libsdl1.2debian libfontconfig net-tools \
