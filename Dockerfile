...
#ubuntu                        wget lib32ncurses5 lib32gcc1 lib32stdc++6 lib32tinfo5 ca-certificates screen tar bzip2 gzip unzip gdb net-tools locales \
                        gdebi-core wget software-properties-common curl apt-transport-https ca-certificates gnupg apt-file gdb ia32-libs lib32z1 lib32stdc++6 lib32stdc++ pushd lib32gcc1 lib32tinfo5 lib64tinfo5 lib32ncurses5 lib32bz2-1.0 lib32* ncurses lib32stdc* libcurl3-gnutls:i386 ncurses5-compat-libs libcurl.i686 libtinfo5:i386 libncurses5:i386 libpng12-0:i386 libjpeg62:i386 libxext6:i386 libxft2:i386 libxinerama1:i386 libstdc++6:i386 libncursesw5:i386 libxcursor1:i386 gcc-8-base glibc tmux libc-bin \
#debian
                       # tmux locales net-tools wget ca-certificates tar gcc g++ lib32gcc1 libgcc1 libcurl4-gnutls-dev:i386 libssl1.1 libcurl4:i386 libtinfo5 lib32z1 lib32stdc++6 libncurses5:i386 libcurl3-gnutls:i386 gdb libsdl1.2debian libfontconfig net-tools \
