...
#ubuntu                        wget lib32ncurses5 lib32gcc1 lib32stdc++6 lib32tinfo5 ca-certificates screen tar bzip2 gzip unzip gdb net-tools locales \
                        gdebi-core wget software-properties-common curl apt-transport-https ca-certificates gnupg apt-file lib32z1 lib32stdc++6 lib32stdc++ lib32gcc1 lib32stdc* libcurl3-gnutls:i386 libtinfo5:i386 libncurses5:i386 libjpeg62:i386 libxext6:i386 libxft2:i386 libxinerama1:i386 libstdc++6:i386 libncursesw5:i386 libxcursor1:i386 gcc-8-base tmux libc-bin \
#debian
